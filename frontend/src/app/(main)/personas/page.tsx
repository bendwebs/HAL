...
export default function PersonasPage() {
  ...
  const startAIAssistant = () => {
    ...
    setAiMessages([{
      role: 'assistant',
      content: `Hi! I'll help you create a great system prompt for your persona. Let me ask you a few questions:

**1. What is this persona's main purpose or role?** (e.g., coding assistant, writing coach, tutor, creative partner)

Please describe what you want this AI persona to help you with.`
    }]);
  };
  ...
  const sendTestMessage = async () => {
    ...
    try {
      ...
      setTestMessages(prev => [...prev, { 
        role: 'assistant', 
        content: 'Error: Could not get response. Check that Ollama is running.' 
      }]);
    } finally {
              ...
              >
                ...
                <div className="flex items-center gap-4 text-xs text-text-muted mb-3">
                  <span className="flex items-center gap-1" title="Temperature">
                    <Cpu className="w-3 h-3" /> {persona.temperature}
                  </span>
                  {persona.model_override && (
                    <span className="flex items-center gap-1 truncate" title="Model">
                      <MessageSquare className="w-3 h-3" /> {persona.model_override.split(':')[0]}
                    </span>
                  )}
                  {persona.default_voice_id && (
                    <span className="flex items-center gap-1" title="Voice">
          ...
          <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-bg-elevated border border-border rounded-xl shadow-lg z-50 p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-muted mt-1">Choose a specific model for this persona</p>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-lg bg-bg-tertiary border border-border text-text-primary focus:outline-none focus:border-accent"
                  >
                    <option value="">No voice (use system default)</option>
                  ...
                  <p className="text-xs text-text-muted mt-1">Voice used when TTS is enabled</p>
                </div>
                  ...
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1 text-xs bg-green-500/10 hover:bg-green-500/20 text-green-400 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1 text-xs bg-accent/10 hover:bg-accent/20 text-accent rounded-lg transition-colors"
                      >
              ...
              <div className="mt-6 border-t border-border pt-6">
                ...
                {generatedPrompt && (
                  <div className="mt-4 p-4 bg-accent/10 border border-accent/30 rounded-lg">
                    <p className="text-sm text-text-secondary mb-2">Generated system prompt ready!</p>
                    <button
              ...
              <div className="mt-6 border-t border-border pt-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-medium text-text-primary flex items-center gap-2">
                    ...
                    <span className="text-xs text-text-muted font-normal ml-2">
                      (Using: {modelOverride || 'default model'})
                    </span>
                  </h3>
                  <button
                ...
                <div className="bg-bg-tertiary rounded-lg p-4 max-h-64 overflow-y-auto mb-4 space-y-4">
                  {testMessages.length === 0 ? (
                    <p className="text-sm text-text-muted text-center py-4">
                      Send a message to test how this persona responds
                    </p>
                  ) : (
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors"
                  >
                    <Send className="w-4 h-4" />
                  </button>
                </div>
            ...
            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-border">
              ...
              <button
                ...
                className="px-6 py-2 bg-accent hover:bg-accent-hover disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors"
              >
